module.exports = {
    ...
    category: 'Moderation',
    usage: '<user> [reason]',
    run: async (client, message, [ mention, ...reason ], Discord) => {
        ...
        try {
            ...
            if (!user)
                return message.reply(`<:cancel:712586986216489011> | ${message.author}, Invalid user ID. Please supply a valid Discord User ID.`);
