...
module.exports = {
    ...
    aliases: ['he-man', 'ihavethepower', 'heman'],
    ...
    run : async(client, message, [ user ], container) => {
        ...
        try {
            const { body } = await request
                .get(`${process.env.API_URL}/canvas/edit-avatar/iHaveThePower`)
            ...
            return message.reply({ files: [{ attachment: body, name: 'i-have-the-power.png' }], embeds: [embed] });
        } catch(err) {
