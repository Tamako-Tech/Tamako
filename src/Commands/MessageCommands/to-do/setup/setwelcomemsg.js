...
module.exports = {
    name: 'setwelcomemsg',
    aliases: [ ],
    description: 'Set up the welcome message. Supports Embeds! [Learn how to set up your Welcome Message](https://tamako.tech/docs/Setup/custom_welcome_message)',
    ownerOnly: false,
    cooldown: 0,
    ...
    run: async (client, message, [stats = '', ...args], container) => guilds.findById(message.guild.id, (err, doc) => {
        ...
        const source = 'https://tamako.tech/docs/Setup/custom_welcome_message';
        const variables = {
            '%TYPE': 'welcome',
            '%ACTION': 'joins',
