...
module.exports = {
    ...
    run: async (client, message, args, container) => {
        try {
                    ...
                    return message.channel.send({
                        embeds:[
                            embed.setDescription([
                                ...
                                '[Learn More](https://tamako.tech/docs/Setup/XP_System) about Tamako\'s Economy System.'
                            ].join('\n'))
                                .setAuthor({name: 'No Credits', iconURL: 'https://cdn.discordapp.com/emojis/767062250279927818.png?v=1'})
                        ]});
                }
                ...
                return message.channel.send({
                    embeds: [
                        new container.Discord.MessageEmbed()
                            .setColor('GREY')
                            .setFooter({text:`Credits Leaderboard | ©️${new Date().getFullYear()} Tamako`})
                            .setAuthor({name: `🏆 ${message.guild.name} Credits Leaderboard`, iconURL: message.guild.iconURL({format: 'png', dynamic: true }) || null})
            ...
            return message.channel.send(`**${message.member.displayName}**, I encountered an error while trying to fetch your XP profile: ${err.message}`);
        }
    }
};
/**
