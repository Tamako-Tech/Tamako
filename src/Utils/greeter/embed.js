...
module.exports = (args, oldEmbed) => {
    ...
    if (!success.length){
        ...
        embed.setAuthor({
            name: embedProps.authorName || embed.author?.name || '',
            iconURL: embedProps.authorImageURL || embed.author?.iconURL || null,
            url: embedProps.authorURL || embed.author?.url || null 
        })
            .setTitle(
            ...
            .setFooter({ 
                text: embedProps.footerText || embed.footer?.text || '',
                iconURL: embedProps.footerImage || embed.footer?.iconURL || null,
            });
